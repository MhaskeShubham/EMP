            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Add New Department</h4>
                    </div>
                    <div id="addUserError">
                    </div>
                    <div class="card-body">
                        <form id="addUser" enctype="multipart/form-data" action="{{ route("department::add") }}" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="DEPTSTATE"  type="text" class="form-control" id="DEPTSTATE" placeholder="Enter State" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="DEPTDIST">District</label>
                                        <input name="DEPTDIST"  type="text" class="form-control" id="DEPTDIST" placeholder="Enter District" required>
                                    </div>
                                </div>
                            </div>
