        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="addUser" enctype="multipart/form-data" action="{{ route("employee::add") }}" method="post">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group date col-md-6">
                                        ...
                                        <input type="text" value="{{date('Y-m-d')}}" class="form-control pull-right input-sm datepicker" name="EMPDOB" id="EMPDOB" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        <label for="EMPSAL">Salary</label>
                                        <input name="EMPSAL"  type="number" class="form-control" id="EMPSAL" placeholder="Enter Salary" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="EMPHOBBIES"  type="text" class="form-control" id="EMPHOBBIES" placeholder="Enter Hobbies" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="DEPTID">Department</label>
                                        <input name="DEPTID"  type="number" class="form-control" id="DEPTID" placeholder="Enter Department id" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
                            ...
                            <div class="box-footer">
                                <a type="button" href="{{ route("employee::index") }}" class="btn btn-danger">Cancel</a>
